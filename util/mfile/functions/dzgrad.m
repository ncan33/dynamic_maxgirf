function [g_slice_selective] = dzgrad(g_platue, n_points_platue, g_dwell, rf_dwell, g_max, slew_max, ifprewinder, ifplot)
%--------------------------------------------------------------------------
%   dzgrad_blipped_caipi(g_platue, n_points_platue, g_dwell, rf_dwell, g_max, slew_max)
%--------------------------------------------------------------------------
%   Design slice selective gradient waveform
%--------------------------------------------------------------------------
%   Inputs:
%       - g_platue          [1x1] [G/cm]
%       - n_points_platue

...
function [seg,phi] = seg_yt_new(I,init_mask,LV_mask,noi,lengthEweight,shapeEweight,display)
  ...
  phi2 = mask2phi(init_mask|LV_mask);
  ...
  for its = 1:noi   % Note: no automatic convergence test
    ...
    vpts = find(phi2>0 & phi2<1.5);                  % exterior points

function [Image,para] = STCR_conjugate_gradient_pixel(Data,para)
...
temporal = @(im) compute_tTV_pixel(im,weight_tTV,beta_sqrd,Data.Motion);
...
%%%%% line search    
    ...
    para.Cost = Cost_STCR_pixel(fidelity_norm, new_img_x, Data.Motion, weight_sTV, weight_tTV, para.Cost); clear fidelity_update
...
%%%%% Low Rank
%{
    if(lambda_low_rank~=0)
        new_img_x = low_rank_yt(new_img_x,32,32,0.0025)*0.25 + new_img_x*0.75;
    end
%}
%%%%% plot&save part 

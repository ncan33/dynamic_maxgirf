function [Image,para] = STCR_conjugate_gradient_MSMS_iso_patch_llr(Data,para)
...
%%%%% fidelity term/temporal/spatial TV
    ...
    if isfield(para.Recon,'bins')
        ...
        update_bins = compute_tTV_bins(new_img_x,weight_tTV,beta_sqrd,para.Recon.bins)*0.5;
        update_bins(permute(Data.llr.mask,[1,2,4,3])) = update_patch(permute(Data.llr.mask,[1,2,4,3]));
        update_term = update_term + update_bins;

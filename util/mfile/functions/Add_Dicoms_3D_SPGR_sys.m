function Add_Dicoms_3D_SPGR_sys(file,DicomFolder)
...
parfor nSlice=1:ns
    DicomFolderLocal = ['ReconData/',DicomFolderName,'_sys_slice_',num2str(nSlice,'%02.f')];
...
%         outnamedia = [DicomFolderLocalDia,'/Img_',num2str(nFrame,'%03.f'),'.dcm'];
        addDicomHeader(Dicom_file_temp, Image_one_slice(:,:,nFrame), seriesNum_sys, [seriesDesc,'sys'], nFrame, outnamesys)

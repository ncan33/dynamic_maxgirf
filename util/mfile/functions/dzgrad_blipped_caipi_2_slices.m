function [grad_blip, g_slice_selective] = dzgrad_blipped_caipi_2_slices(g_platue, n_points_platue, g_dwell, rf_dwell, g_max, slew_max, area_blip, ifprewinder, ifplot)
%--------------------------------------------------------------------------
...
while flag
    ...
    g_rewinder_platue_add = - area_blip_running / n_steps_rewinder_bottom_negtive / g_dwell;
...
% pre: +, post: 0
if ifprewinder
    grad_1 = [g_prewinder_negtive; g_platue; g_rewinder];
else
    grad_1 = [g_platue; g_rewinder];
end

% pre: 0, post: -
if ifprewinder
    grad_2 = [g_prewinder; g_platue; g_rewinder_positive];
else
    grad_2 = [g_platue; g_rewinder_bottom_negtive];
end


grad_blip = [grad_1, grad_2];

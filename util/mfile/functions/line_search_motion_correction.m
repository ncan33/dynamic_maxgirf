function step = line_search_motion_correction(old,update,Data,para)
...
for i=1:max_try
    ...
    switch para.Recon.type
        ...
        otherwise
            cost_new = Cost_STCR_motion_correction(fidelity_new,new,Data.Motion,para.Recon.weight_sTV,para.Recon.weight_tTV);
    end

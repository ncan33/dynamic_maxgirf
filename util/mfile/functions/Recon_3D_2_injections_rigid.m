function Image = Recon_3D_2_injections_rigid(Data,para)
...
Data_temp.kSpace = rigid_regisgtration_3D(Image.pd,Data_temp);
para.Recon.noi = 70;
...
Data_temp.kSpace = rigid_regisgtration_3D(Image.inj1,Data_temp);
para.Recon.noi = 70;
para.Recon.weight_tTV = para.Recon.weight_tTV*5;
Image.inj1 = STCR_conjugate_gradient_3D(Data_temp,para);

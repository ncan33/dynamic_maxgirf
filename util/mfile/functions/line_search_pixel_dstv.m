function step = line_search_pixel_dstv(old,update,Data,para)
...
for i=1:max_try
    ...
    switch para.Recon.type
        ...
        otherwise
            cost_new = Cost_STCR_pixel_dstv(fidelity_new,new,Data,para.Recon.weight_sTV,para.Recon.weight_tTV);
    end

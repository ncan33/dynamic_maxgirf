function recon_rthawk_sms_cine_revision(vol_number)

area = 'heart';
n_vol = length(vol_number);

for ivol = 1:n_vol
    path_server = dir(sprintf('/server/sdata/mri_data/disc/%s/vol%04g_*', area, vol_number(ivol)));
...
%         for weight_tTV = 4e-4 %[1e-8, 1e-7, 1e-6, 1e-5, 1e-4, 2e-4, 4e-4, 1e-3, 2e-3, 4e-3, 1e-2, 1e-1, 1]
%             for weight_sTV = [1e-8, 1e-7, 1e-6, 1e-5, 1e-4, 2e-4, 4e-4, 1e-3, 2e-3, 4e-3, 1e-2, 1e-1, 1]

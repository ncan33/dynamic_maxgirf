function [Image,para] = STCR_conjugate_gradient_3D_cluster_tv(Data,para)
...
%%%%% fidelity term/temporal/spatial TV
    ...
    tic;
    update_term = update_term + compute_3DtTV_yt(new_img_x,weight_tTV,beta_sqrd) * 0.5;
    ...
    update_term = update_term + weight_tTV * apply_patch_cluster_ttv_3D(new_img_x, Data.patch) * 0.5;

function fidelity_update = compute_fidelity_simu_gNUFFT(ifNUFFT,nSMS,kSpace_type,image,kSpace,sens_map,sens_map_conj,phase_mod,phase_mod_conj,varargin)
...
if ifNUFFT == 1
    ...
    fidelity_update = fidelity_update*8; % number need to test

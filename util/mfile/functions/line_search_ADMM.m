...
%     end
    if isfield(Data, 'Y')
        cost_new = Cost_STCR_step_3(fidelity_new, gather(new), para.Recon.weight_sTV, para.Recon.weight_tTV, Data.first_guess - Data.Y, para.Recon.weight_l2);
    else
        cost_new = Cost_STCR_step_2(fidelity_new, new, para.Recon.weight_sTV, para.Recon.weight_tTV);
    end

function [Image_sys,Image_dia,Image_cine,Image,para] = prepare_Data_2D_ungated_slice_group_6(kSpace_all,kSpace_info,para)
...
Data_all.kSpace = cat(6,Data{1}.kSpace,Data{2}.kSpace,Data{3}.kSpace,Data{4}.kSpace,Data{5}.kSpace,Data{6}.kSpace);
Data_all.mask = cat(6,Data{1}.mask,Data{2}.mask,Data{3}.mask,Data{4}.mask,Data{5}.mask,Data{6}.mask);
Data_all.first_est = cat(6,Data{1}.first_est,Data{2}.first_est,Data{3}.first_est,Data{4}.first_est,Data{5}.first_est,Data{6}.first_est);
Data_all.sens_map = cat(6,Data{1}.sens_map,Data{2}.sens_map,Data{3}.sens_map,Data{4}.sens_map,Data{5}.sens_map,Data{6}.sens_map);
...
save([para.dir.save_recon_img_mat_dir,para.dir.save_recon_img_name],'Image_sys','Image_dia','para','-v7.3');

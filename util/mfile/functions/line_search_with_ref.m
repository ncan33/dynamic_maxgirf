function step = line_search_with_ref(old,update,Data,para)
...
for i=1:max_try
    ...
    switch para.Recon.type
        ...
        otherwise
            cost_new = Cost_STCR(fidelity_new,new-Data.ref,para.Recon.weight_sTV,para.Recon.weight_tTV);
    end

function kSpace = phase_correction(kSpace)
...
center_line_after  = squeeze(kSpace(145,:,:,:,:));
...
center_line_before = reshape(center_line_before,[siz(1)*siz(2),siz(3),siz(4)]);
center_line_after  = reshape(center_line_after,[siz(1)*siz(2),siz(3),siz(4)]);

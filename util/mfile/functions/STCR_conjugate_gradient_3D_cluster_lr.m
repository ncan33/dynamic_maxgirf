function [Image,para] = STCR_conjugate_gradient_3D_cluster_lr(Data,para)
...
%%%%% fidelity term/temporal/spatial TV
    ...
    update_term = update_term + weight_lr * (apply_patch_cluster_low_rank_3D(new_img_x, Data.patch, tau) - new_img_x);

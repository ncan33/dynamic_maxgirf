function [Image,para] = iteration_recon_Toeplitz_new(first_est,kSpace,mask,sens_map,Apodizer,para,varargin)
...
%%%%% fidelity term/temporal/spatial TV
    ...
    if nSMS ~= 1
        fidelity_update_temp(:,:,:,:,1,1,1) = sum(fidelity_update,6);

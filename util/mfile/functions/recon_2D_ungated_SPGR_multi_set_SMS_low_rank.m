function [Image_sys,Image_dia,Image,para] = recon_2D_ungated_SPGR_multi_set_SMS_low_rank(kSpace_all,kSpace_info,para)
...
para.setting.ifplot = 0;
for i=1:nset
    Data{i}.first_guess = Image(:,:,:,i,:);
    Image(:,:,:,i,:) = STCR_conjugate_gradient_low_rank_bins(Data{i},para);
    save('Image_rest_recon_21_rays.mat','Image','-v7.3')
end
save('Image_rest_recon_21_rays.mat','para','-append');

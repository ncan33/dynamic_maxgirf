function sTV_update = compute_sTV_3D_yt(img,weight,beta_sqrd)
...
if weight~=0
    ...
    T5_num = cat(3,diff_z,zeros([siz(1:2),1,siz(4:end)]));
    T6_num = cat(3,zeros([siz(1:2),1,siz(4:end)]),diff_z);
    ...
    T6 = cat(3,zeros([siz(1:2),1,siz(4:end)]),T5(:,:,1:end-1,:,:,:));

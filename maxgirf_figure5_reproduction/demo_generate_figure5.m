...
% Modified by Nejat Can
% Email: ncan@usc.edu (preferred)

%% Clean slate
close all; clear; clc;

%% Set the directory names
output_directory = './maxgirf_figure5_reproduction/se_spiral_1102_ax_s24_osf1_B0correction1_concomitant_correction1_Lmax50_L8';
data_directory = '/server/sdata/ncan/mri_data/disc/brain/vol001/spiral';
B0map_fullpath = '/server/sdata/ncan/mri_data/disc/brain/vol001/spiral/B0map_nlinv_min1.0e-06_axial.mat';
...
if contains(output_directory, '_sag_')
    reorient = @(x) x;
    axis_text = 'x';
elseif contains(output_directory, '_cor_')
    reorient = @(x) x;
elseif contains(output_directory, '_ax_')

function [Image,para] = STCR_conjugate_gradient_MSMS_low_rank_bins(Data,para)
...
%%%%% fidelity term/temporal/spatial TV
    ...
    tic;
    update_term = update_term + temporal(new_img_x)*0.75;
    ...
    update_term = update_term + compute_slice_TV_MSMS(new_img_x,weight_tTV,beta_sqrd)*0.05;

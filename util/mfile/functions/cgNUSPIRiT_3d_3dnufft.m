function [res,FLAG,RELRES,ITER,RESVEC,LSVEC] = cgNUSPIRiT_3d_3dnufft(kspace, x0, N, kernel, niter, lambda)
...
if strcmp(tflag, 'transp')
    ...
    y1 = zeros(imSize);
    for iz = 1:imSize(3)
        y1(:, :, iz, :) = NUFFT3.NUFFT_adj(x1(:, :, iz, :), N);
    end

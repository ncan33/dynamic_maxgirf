function [Image,para] = STCR_conjugate_gradient_T1(Data,para)
...
%%%%% fidelity term/temporal/spatial TV
    ...
    %tic;    
    %tic;
    %update_term = update_term + reshape(temporal(reshape(new_img_x,[288,288,5,8,para.Recon.nSMS])),[288,288,40,1,para.Recon.nSMS]);
